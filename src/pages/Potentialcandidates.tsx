...
const PotentialCandidates = () => {
  const candidates = [
    ...
    {
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZv8oMiKv7_qFQvzayLwUZ8Gz2QSU3smv5Ig&s',
      name: 'Lisa Coding',
      username: 'LisaaaaC',
      location: 'Austin, TX',
    ...
    {
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdTT0dok_f1YY7pmOjgpi7l45CVcAvkl9LFQ&s',
      name: 'Tim Chen',
      username: 'TChen90',
      location: 'China',
          ...
          {candidates.map((candidate, index) => (
            <tr key={index} style={{ borderBottom: '1px solid #ffffff' }}>
              <td style={{ textAlign: 'center', padding: '0.5rem' }}>
                <img src={candidate.image} alt={candidate.name} style={{ width: '50px', borderRadius: '50%' }} />
              </td>
